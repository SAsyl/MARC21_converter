...
def split_authors(authors: str) -> list[str]:
    ...
    if len(splittedAuthors) != 2:
        splittedAuthors.append('')

    return splittedAuthors
...
with open("./MegaPro/BooksDB/LittlePart.csv", "r", encoding='utf-16') as csvfile:
    ...
    with open("./MegaPro/BooksDB/new.csv", "w", encoding='utf-16', newline='') as newFile:
        ...
        for row in reader:
            ...
            # row['Authors'], row['Authors2'] = split_authors(row['Authors'])

            writer.writerow(row)

with open("./MegaPro/BooksDB/new.csv", "r", encoding='utf-16') as first_element:
    ...
    for element in reader:
        ...
        with open("./MegaPro/BooksDB/results.mrc", "a", encoding='utf-16') as resFile:
